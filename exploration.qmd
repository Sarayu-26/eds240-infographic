...
#adding readable gear labels by first creating a lookup table 
gear_labels <- c(
...
#add readable gear column to "fleet" 
fleet <- fleet %>%
  mutate(
    geartype_label = recode(as.character(geartype), !!!gear_labels)
  )

#save csv with updated changes 
write_csv(
  fleet,
